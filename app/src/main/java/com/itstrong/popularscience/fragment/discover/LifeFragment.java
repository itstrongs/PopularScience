 ...
 */
public class LifeFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mContentView = inflater.inflate(R.layout.fragment_life, container, false);
    ...
    public void findViewById() {
        ...
        mRecyclerView = (RecyclerView)mContentView.findViewById(R.id.recycler_life);
    }
    ...
    public void processLogic() {
        mActivity.setFragmentTitle("科普生活");
...
//            textContent = (TextView)view.findViewById(R.id.text_head_line_content);
        ...
        public void onClick(View v) {
            mActivity.switchFragmentPage(mActivity.SWITCH_DISCOVER_DISPLAY, mItemList.get(getLayoutPosition()).getId(), "3");
        }
    }
}
